...
<head>
    ...
    <title>{{ $title ?? 'Admin - TroPlus' }}</title>
                    ...
                    <ul class="nav flex-column mt-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('admin.users*') ? 'active' : '' }}"
                                href="{{ route('admin.users') }}"> {{-- ✅ thêm route --}}
                                <i class="bi bi-people"></i> Người dùng
                            </a>
                        </li>
                        <li class="nav-item">
                           <!-- sidebar link -->
<a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('admin.products*') ? 'active' : '' }}"
    href="{{ route('admin.products') }}">
    <i class="bi bi-house"></i> Bài đăng
</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('admin.comments*') ? 'active' : '' }}"
                                href="{{ route('admin.comments') }}">
                                <i class="bi bi-chat-square-text"></i> Đánh giá
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('admin.upgrades*') ? 'active' : '' }}"
                                href="{{ route('admin.upgrades') }}">
                                <i class="bi bi-person-up"></i> Yêu cầu nâng cấp
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <div>
                    <div class="sidebar-user d-flex align-items-center gap-2 mb-2">
                        <img src="{{ asset('storage/admin.jpg') }}"
